...
public class LocationContactBuilder {
    ...
    public LocationContactBuilder setFormattedPhoneNumber(String formattedPhoneNumber)
    {
    ...
    {
        return new LocationContact(firstName, lastName, fullName, phoneNumber, formattedPhoneNumber, email, locationContactID, clientID);
    }
}