...
public class EmployeeBuilder {
    ...
    public EmployeeBuilder setFormattedPhoneNumber(String formattedPhoneNumber)
    {
    ...
    {
        return new Employee(employeeID, employeeStatusID, employeeTypeID, firstName, middleInitial, lastName, fullName, suffix, salary, salaryFrequencyID, addressLineOne, addressLineTwo, city, regionID, countryID, zipCode, phoneNumber, formattedPhoneNumber, email);
    }
}