...
public class Project
{
    ...
    public Project(int projectID, int projectStatusID, int projectTypeID, String projectName, Date projectBidDate, Date projectStartDate, String projectNotes, int clientID)
    {
