...
class DataImporter
{
    ...
    DataImporter() throws IOException
    {

        /*File pureNameList = new File("Data/purenamelist.txt");
        File otherNameList = new File("Data/othernamelist.txt");*/
        File clientDataList = new File("D:\\Dropbox\\School\\Fall 2016\\CIS 3365\\SQL Scripts\\Ethan\\Master Files\\Data\\clientdata.txt");

        in = new FileReader("D:\\Dropbox\\School\\Fall 2016\\CIS 3365\\SQL Scripts\\Ethan\\Master Files\\Data\\clientdata.csv");
